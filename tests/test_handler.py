...
class HandlerTest(unittest.TestCase):
    def test_handle_pre_commit_applies_diff_and_syncs_tracked_paths(self) -> None:
        ...
        with (
            ...
            patch.object(handler, "_handle_cached_diff", wraps=handler._handle_cached_diff) as handle_cached_diff,
    ...
    def test_handle_post_rewrite_applies_all_valid_pairs(self) -> None:
        ...
        with patch("hooks.handler.sys.stdin", stdin), patch.object(handler, "_apply_ref_diff") as apply_ref_diff:
            handler.handle_post_rewrite(index)
